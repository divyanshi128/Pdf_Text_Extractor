...
export default function Home() {
  ...
  // function to summarize text using API
  ...
  //  funtion to handle file input changes
  const onChangeFileInput = (event) => {
    const file = event.target.files[0];

    // if file is not of pdf type
  ...
  return (
    ...
    >
      ...
      {/* Display the raw text and summarized text */}
